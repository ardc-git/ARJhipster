package com.ardc.clinic.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "AR_clinic@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "AR_clinic API";

        private String description = "AR_clinic API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "AR_clinic";
